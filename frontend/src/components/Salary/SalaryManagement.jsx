...
const handleInputChange = (e) => {
  ...
  const handleEditSalary = async (salary) => {
    try {
      ...
      // Load previous month's remaining leaves for this employee
      let previousRemainingLeaves = 0;
      try {
        const allSalaries = await salaryService.getSalaries();
        const employeeSalaries = allSalaries.salaries.filter(
          sal => sal.employeeId === salaryDetails.employeeId
        );
        if (employeeSalaries.length > 0) {
          const monthOrder = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
          const sortedSalaries =  employeeSalaries.sort((a, b) => {
            const yearDiff = b.year - a.year;
            if (yearDiff !== 0) return yearDiff;
            return monthOrder.indexOf(b.month) - monthOrder.indexOf(a.month);
          });
          
          const currentIndex = sortedSalaries.findIndex(s => s._id === salaryDetails._id);
          if (currentIndex > 0) {
            previousRemainingLeaves = sortedSalaries[currentIndex - 1].remainingLeaves || 0;
          }
        }
      } catch (error) {
        console.error('Error loading previous salaries:', error);
      }

      setPreviousMonthLeaves(previousRemainingLeaves);
                ...
                <div className="form-sections">
                    ...
                    {employeeDetails && (
                      <div className="employee-auto-fill">
                        <div className="auto-fill-info">
                          ...
                          <p><strong>Pan Number :</strong> {employeeDetails.panNumber}</p>
                    ...
                    <div className="form-grid">
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          min="0"
                        />
                        <small className="form-help">Enter remaining leaves for this month</small>
                      </div>
                      <div className="form-group">
                  ...
                  <div className="form-section">
                    ...
                    <div className="summary-table">
                      ...
                      {calculatedValues.lopDays > 0 && (
                        <div className="summary-table-row highlight">
                          <span className="summary-table-label">Adjusted Basic Pay:</span>
                          <span className="summary-table-value">Rs.{calculatedValues.basicPay.toFixed(2)}</span>
                        </div>
                      )}
